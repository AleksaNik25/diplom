...
<div class="site-index">
    ...
    <section class="vk-hero">
        <div class="vk-hero-left justify-content-between">
            <div>
                <h1>Окружи себя природой</h1>
                <p>Маркетплейс растений от проверенных продавцов. <br> Найди своё идеальное растение и создай уголок природы дома.</p>
            </div>
            <div class="vk-hero-btns">
                <a class="btn button-index align-item-end" href="/catalog">Наши товары
                    <div class="icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 208.52 511.88" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <defs></defs>
                            <g id="Layer_x0020_1">
        ...
        <div class="vk-hero-right">
            <img class="vk-hero-sale" src="../web/img/sale.svg" alt="">
            <div class="vk-hero-plant">
                <img class="vk-hero-img" src="../web/img/zeltn-hero.png" alt="">
            </div>
        </div>
    </section>
    ...
    <div class="jumbotron text-center bg-transparent mt-5 mb-5">
        ...
        <p class="lead">Приносим природу в ваш дом <br> Маркетплейс растений и всего необходимого для ухода за ними</p> -->
    ...
    <section class="py-5 my-4">
        <div class="container">
            <h1 class="title-style text-center mb-4">Почему нас выбирают</h1>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="vk-feat-card h-100">
                        <div class="vk-feat-icon">
                            <i class="fas fa-leaf fa-lg" style="color: #3A7F0C;"></i>
                        </div>
                        <h5 class="vk-feat-h">Живые растения от <br> проверенных продавцов</h5>
                        <p class="vk-feat-p">Каждый продавец проходит проверку. Вы получаете здоровые растения с подробным описанием ухода.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="vk-feat-card h-100">
                        <div class="vk-feat-icon">
                            <i class="fas fa-truck fa-lg" style="color: #3A7F0C;"></i>
                        </div>
                        <h5 class="vk-feat-h">Бережная доставка</h5>
                        <p class="vk-feat-p">Упаковываем растения так, чтобы они приехали к вам целыми и счастливыми — даже в морозы.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="vk-feat-card h-100">
                        <div class="vk-feat-icon">
                            <i class="fas fa-comments fa-lg" style="color: #3A7F0C;"></i>
                        </div>
                        <h5 class="vk-feat-h">Сообщество любителей растений</h5>
                        <p class="vk-feat-p">Оставляйте отзывы, задавайте вопросы продавцам и делитесь опытом с другими покупателями.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container d-lg-block d-none">
        <h1 class="title-style text-center mb-3">Топовые товары</h1>
