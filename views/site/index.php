...
<div class="site-index">
    ...
    <div class="jumbotron text-center bg-transparent mt-5 mb-5">
        ...
        <a class="btn button-index" href="/catalog">Наши товары
            <div class="icon-1">
        ...
        <!-- <p><?php # Html::a('Наши товары', ['/catalog'], ['class' => 'btn btn-success']) 
                ?></p> -->
    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="vk-feat-card h-100">
                            ...
                            <h5 style="font-size:16px; font-weight:700; color:#1A3306; margin:0 0 8px;">Живые растения от проверенных продавцов</h5>
                            <p style="font-size:14px; color:#3A7F0C; margin:0; line-height:1.6;">Каждый продавец проходит проверку. Вы получаете здоровые растения с подробным описанием ухода.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="vk-feat-card h-100">
                            ...
                            <h5 style="font-size:16px; font-weight:700; color:#1A3306; margin:0 0 8px;">Бережная доставка</h5>
                            <p style="font-size:14px; color:#3A7F0C; margin:0; line-height:1.6;">Упаковываем растения так, чтобы они приехали к вам целыми и счастливыми — даже в морозы.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="vk-feat-card h-100">
                            ...
                            <h5 style="font-size:16px; font-weight:700; color:#1A3306; margin:0 0 8px;">Сообщество любителей растений</h5>
                            <p style="font-size:14px; color:#3A7F0C; margin:0; line-height:1.6;">Оставляйте отзывы, задавайте вопросы продавцам и делитесь опытом с другими покупателями.</p>
                        </div>
                    </div>
                </div>
        </div>
