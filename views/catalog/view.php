...
<div class="product-view">
    ...
    $images = array_map(function ($item) use ($model) {
        return "<img src=\"/img/$item->photo\" alt=\"$model->title\" style=\"width: 100%; height: auto; max-height: 450px; object-fit: contain;\" class=\"d-block\">";
    }, $model->productImages);
    ?>
        ...
        <div class="container mt-4">
            <div class="row g-4 justify-content-center">
                <div class="col-12 col-md-6 d-flex justify-content-center">
                    <div class="card img-view w-100" style="max-width: 30rem; max-height: 30rem;">
